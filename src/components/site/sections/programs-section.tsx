...
const PROGRAMS = [
  { title: "Menstrual Hygiene Awareness Day", date: "May 28, 2026", time: "All day", location: "Madina Estate, Accra", image: "/images/programs/mhd-joy.jpg", description: "In partnership with Gyedzi Foundation, we delivered 1,000 sanitary pads and broke the stigma around menstruation in schools. Health personnel led sessions with students, parents, and teachers.", pillar: "Wellbeing", past: true },
